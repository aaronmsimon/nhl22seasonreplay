...
*/
    ...
    public function getVersusRecord($teamid1, $teamid2) {
      $this->db->select();
      $this->db->from('schedule as s');
      $this->db->join('games as g','s.id = g.schedule_id');
      $this->db->where("(s.hometeam_id = $teamid1 AND s.awayteam_id = $teamid2) OR (s.hometeam_id = $teamid2 AND s.awayteam_id = $teamid1)");
    }
